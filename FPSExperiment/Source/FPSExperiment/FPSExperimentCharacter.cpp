...
void AFPSExperimentCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AFPSExperimentCharacter::OnResetVR);
...
void AFPSExperimentCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AFPSExperimentCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AFPSExperimentCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool AFPSExperimentCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AFPSExperimentCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AFPSExperimentCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AFPSExperimentCharacter::TouchUpdate);
		return true;
	}
